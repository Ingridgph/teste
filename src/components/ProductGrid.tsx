...
export default function ProductGrid() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(".vitrine-title", { opacity: 0, x: -60 }, {
        opacity: 1, x: 0, duration: 1, ease: "power3.out",
        scrollTrigger: { trigger: ".vitrine-title", start: "top 85%", toggleActions: "play none none none" },
      });
      gsap.fromTo(".vitrine-subtitle", { opacity: 0, x: -40 }, {
        opacity: 1, x: 0, duration: 0.8, ease: "power3.out", delay: 0.15,
        scrollTrigger: { trigger: ".vitrine-title", start: "top 85%", toggleActions: "play none none none" },
      });
      gsap.fromTo(".vitrine-tab", { opacity: 0, y: 20, scale: 0.9 }, {
        opacity: 1, y: 0, scale: 1, stagger: 0.06, duration: 0.5, ease: "back.out(1.4)",
        scrollTrigger: { trigger: ".vitrine-tabs", start: "top 90%", toggleActions: "play none none none" },
      });
      gsap.fromTo(".vitrine-search", { opacity: 0, width: 0 }, {
        opacity: 1, width: "auto", duration: 0.6, ease: "power2.out",
        scrollTrigger: { trigger: ".vitrine-tabs", start: "top 90%", toggleActions: "play none none none" },
      });
    }, sectionRef);
    return () => ctx.revert();
  ...
  return (
    <section ref={sectionRef} id="vitrine" style={{ backgroundColor: "var(--background)", paddingBottom: "6rem" }}>
      <div className="mx-auto max-w-7xl px-4 pb-6 pt-20 sm:px-6">
        <h2 className="vitrine-title text-3xl font-bold tracking-tight md:text-5xl" style={{ color: "var(--foreground)" }}>
          Nossos Produtos
        </h2>
        <p className="vitrine-subtitle mt-2 text-lg" style={{ color: "var(--muted)" }}>Selecione e peca pelo WhatsApp</p>
      </div>
      ...
      <div className="mx-auto mt-6 space-y-14 px-8 sm:px-12 lg:px-16">
        {grouped.length === 0 ? (
